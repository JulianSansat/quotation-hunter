...
RSpec.describe 'Quotations API', type: :request do
    ...
    describe 'get currency quotations of last day' do
        before do
            ...
            create_list(:quotation, 2, currency_code: currency, created_at: last_day.beginning_of_day)
            create(:quotation, currency_code: currency, created_at: last_day.end_of_day)
    ...
    describe 'get currency quotations of last week' do
        before do
    ...
    describe 'get currency quotations of last month' do
        before do
